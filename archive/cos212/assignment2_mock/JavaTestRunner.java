...
public class JavaTestRunner {
	...
	public static void main(String[] args) {
		...
		UnitTest suite_Task1 = new tests_Task2();
		printHeader("Task 2");
		...
		printFooter("Testing DoubleThreadedAVL", suite_Task1.testResult, suite_Task1.testsPassed, suite_Task1.testsCount, suite_Task1.assertsPassed, suite_Task1.assertsCount);
